...
interface ServicesDataProps {
    initialData?: ServicesType | null;
}
const ServicesForm: React.FC<ServicesDataProps> = ({ initialData }) => {

    const [form, setForm] = useState<ServicesType>(initialData ? initialData : DEFAULT_FORM_STATE,);
